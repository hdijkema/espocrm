...
define('views/fields/iperson-name', 'views/fields/person-name', function (Dep) {

    return Dep.extend({

        type: 'ipersonName',

        detailTemplate: 'fields/iperson-name/detail',

        editTemplate: 'fields/iperson-name/edit',

        editTemplateLastFirst: 'fields/iperson-name/edit-last-first',

        editTemplateLastFirstMiddle: 'fields/iperson-name/edit-last-first-middle',

        editTemplateFirstMiddleLast: 'fields/iperson-name/edit-first-middle-last',
